...
- If you're using Glitch:
  ...
  - If you've got a custom domain in front of your Glitch project, add a key to your .env called `BASE_URL` with the value set to the hostname (the part after the https://) at which you want the project to be accessible.
...
- Otherwise:
  ...
  - Add the line `BASE_URL=<hostname>` to your .env where \<hostname\> is the hostname of your instance.
